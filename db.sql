...
ALTER TABLE ACTOR ADD CONSTRAINT FK_SEXO_ACTOR FOREIGN KEY (SEX_ID) REFERENCES SEXO (SEX_ID);
ALTER TABLE ACTOR_PELICULA ADD CONSTRAINT FK_ACTOR_ACTOR_PELICULA FOREIGN KEY (ACT_ID) REFERENCES ACTOR (ACT_ID);
ALTER TABLE ACTOR_PELICULA ADD CONSTRAINT FK_PELICULA_ACTOR_PELICULA FOREIGN KEY (PEL_ID) REFERENCES PELICULA (PEL_ID);
ALTER TABLE ALQUILER ADD CONSTRAINT FK_PELICULA_ALQUILER FOREIGN KEY (PEL_ID) REFERENCES PELICULA (PEL_ID);
ALTER TABLE ALQUILER ADD CONSTRAINT FK_SOCIO_ALQUILER FOREIGN KEY (SOC_ID) REFERENCES SOCIO (SOC_ID);
ALTER TABLE PELICULA ADD CONSTRAINT FK_DIRECTOR_PELICULA FOREIGN KEY (DIR_ID) REFERENCES DIRECTOR (DIR_ID);
ALTER TABLE PELICULA ADD CONSTRAINT FK_FORMATO_PELICULA FOREIGN KEY (FOR_ID) REFERENCES FORMATO (FOR_ID);
ALTER TABLE PELICULA ADD CONSTRAINT FK_GENERO_PELICULA FOREIGN KEY (GEN_ID) REFERENCES GENERO (GEN_ID);
